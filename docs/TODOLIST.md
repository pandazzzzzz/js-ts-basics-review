...
> **Updated**: 2026-09-03
> **ES version verification**: 2026-09-03 · See [TC39 Finished Proposals](https://github.com/tc39/proposals/blob/main/finished-proposals.md) · reference/lastVerified
...
**16 Classes** — class syntax, inheritance, mixin, instanceof in depth, class vs prototype comparison, composition over inheritance, strategy pattern (strategy lives in `25-inheritance-patterns.js` — see cross-file note)
