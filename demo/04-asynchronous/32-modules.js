...
console.log("  ⚠️  `export default const x = ...` is a syntax error — declare first, then export\n");
...
console.log("  CJS (Node.js traditional):  const mod = require('./mod'); module.exports = { ... };");
...
console.log("  Analysis     | CJS dynamic (runtime)            | ESM static (parse-time, tree-shakeable)");
console.log("  Exports      | CJS exports are copies           | ESM imports are live bindings (read-only)");
console.log("  Top-level    | CJS this === module.exports      | ESM this === undefined");
console.log("  Extensions   | CJS .js/.cjs                     | ESM .mjs or .js + \"type\":\"module\"");
console.log("  Top-level await | CJS: not supported           | ESM: supported (ES2022)");

console.log("\n  Interop:");
console.log("  ESM can import CJS: import cjs from './module.cjs'; (default import = module.exports)");
console.log("  CJS can import ESM only via dynamic import: const esm = await import('./module.mjs');");

console.log("\n  Migration tips:");
console.log("  1. Add \"type\": \"module\" to package.json");
console.log("  2. Replace require → import, module.exports → export");
console.log("  3. Replace __dirname: const __dirname = fileURLToPath(new URL('.', import.meta.url));");
...
console.log("  Solutions: extract shared code to third module, use dependency injection, redesign\n");
