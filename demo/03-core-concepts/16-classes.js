...
// - `class` keyword defines a class, syntactic sugar over constructor functions
// - Class declarations are hoisted but in TDZ, must be declared before use
// - Instance methods are defined on prototype, non-enumerable
class Person {
