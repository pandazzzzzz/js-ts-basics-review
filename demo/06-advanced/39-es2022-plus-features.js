...
// - Reached Stage 4 in June 2026, part of ES2027
console.log("\n=== Atomics.pause (ES2027) ===");

console.log("NOTE: Atomics.pause reached Stage 4 in June 2026 and is part of ES2027.");
console.log("Browser/runtime support is emerging. Check caniuse.com for current status.");
...
// Each iteration yields an array of values from the iterables
`);
