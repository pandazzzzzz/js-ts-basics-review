...
console.log("  Attributes: HttpOnly (prevent XSS access), Secure (HTTPS only), SameSite (CSRF protection), Max-Age/Expires, Path, Domain");
...
// ============================================
console.log("\n3. IndexedDB:");
console.log("  Asynchronous client-side database for large structured data (unlimited size, browser-dependent)");
...
// ============================================
console.log("\n4. History API:");
console.log("  Manipulate browser history without page reload: pushState(), replaceState(), popstate event");
...
console.log("  Best practices: always handle direct URL access (server-side fallback), update document.title");
